...
// node_modules/vite-react-ssg/node_modules/react-helmet-async/lib/index.module.js
...
// node_modules/vite-react-ssg/dist/shared/vite-react-ssg.DTTf7HZy.mjs
...
function render(app, container, renderOptions = {}) {
  ...
  if (useLegacyRender || !isReact18) {
    ...
    import("./client-IV6QFTAQ.js").then(({ default: { createRoot } }) => {
...
function hydrate(app, container, renderOptions = {}) {
  ...
  if (useLegacyRender || !isReact18) {
    ...
    import("./client-IV6QFTAQ.js").then(({ default: { hydrateRoot } }) => {
      import_react2.default.startTransition(() => {
...
function ViteReactSSG(routerOptions, fn, options = {}) {
  ...
  if (isClient) {
    (async () => {
      ...
      const lazeMatches = (_a = matchRoutes(
        routerOptions.routes,
        window.location,
        BASE_URL
      )) == null ? void 0 : _a.filter((m2) => m2.route.lazy);
  ...
  function transformStaticLoaderRoute(route) {
    ...
    const loader = async ({ request }) => {
      if (true) {
        ...
        const routeData = (_a = window.__VITE_REACT_SSG_STATIC_LOADER_DATA__[pathname]) == null ? void 0 : _a[route.id];
